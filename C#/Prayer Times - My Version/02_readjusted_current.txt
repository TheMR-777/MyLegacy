...
class Program
{
    static void Main()
    {
        var apiRes = new HttpClient().GetAsync("https://api.aladhan.com/v1/timingsByCity/20-10-2023?city=Jhelum&state=Punjab&country=Pakistan&method=8&school=1").Result;
        ...
        if (apiRes.IsSuccessStatusCode)
        {
            ...
            var nextOne = prayers[(prayer + 1) % 5];
            ...
            var formatted = $"{current} — *{now}* _to_ *{end}*";
