...
namespace TheProgram
{
	public class RSAEncryptionBouncyCastle
	{
		...
		public static AsymmetricKeyParameter LoadPublicKey(string certificatePath)
		{
            var rsa = RSAEncryption.LoadPublicKey(certificatePath);
	...
	{
		public static RSAParameters LoadPublicKey(string certificatePath)
		{
	...
	public class Demo
	{
		...
		private static readonly string keyPath = @"D:\PNB Remittance\new_cert.txt";
		...
		public static void Main()
		{
			while (true)
			{
				...
				var rsaKey = RSAEncryption.LoadPublicKey(keyPath);
				var bocKey = RSAEncryptionBouncyCastle.LoadPublicKey(keyPath);
