...
class JWTGenerator
{
    private static readonly string kid = "pVMomQ1NwB6nKuSAxaQDM0PrBg0";
    private static readonly string key_PEM = @"D:\PayUK\obsigning.key";
    ...
    static string GenerateJWT(Dictionary<string, Dictionary<string, string>> payload, Dictionary<string, object> headers, string keyPath, string issuer, string audience)
    {
