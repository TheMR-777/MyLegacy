...
public static class Evolver
{
    ...
    private class EvolverContext
    {
        public class ClientContext
        {
            ...
            public List<string> Restoration { get; set; } = [];
        }
    ...
    public static void Main(string[] arguments)
    {
        ...
        // Parse and validate the JSON argument
        try
        {
        ...
        {
            LogError($"Error parsing arguments: {x.Message}");
            return;
        }
    ...
    private static EvolverContext ParseArguments(string[] arguments)
    {
        ...
        try
        {
            context = JsonSerializer.Deserialize<EvolverContext>(jsonContext)!;
        }
    ...
    private static void TerminateTheClientApp()
    {
        try
        {
            var processes = Process.GetProcesses()
                .Where(p => p.ProcessName.Contains(Configuration.context.Client.Executable, StringComparison.OrdinalIgnoreCase))
                .ToList();
    ...
    {
        var src = Configuration.context.PackagePath;
    ...
    private static void InitiateTheClientApp()
    {
        try
        {
            ...
            process.Start();
            Log($"Client app started with: '{process.StartInfo.Arguments}'");
        }
        catch (Exception ex)
        {
