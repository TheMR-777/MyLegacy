...
namespace hash
{
	...
	{
		return std::span{ SHA(reinterpret_cast<const openssl_value_type*>(input.data()), input.size(), nullptr), digest_length }
...
int main()
{
	constexpr auto the_data = "TheMR - gwzD0C8lZ5GRoDYSfDJMgcYI";
